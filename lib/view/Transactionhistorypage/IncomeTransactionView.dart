...
class IncomeTransactionView extends StatefulWidget {
  String username;
  IncomeTransactionView({super.key,
  required this.username});

  @override
  State<IncomeTransactionView> createState() => __IncomeTransactionViewStateState();
}

class __IncomeTransactionViewStateState extends State<IncomeTransactionView> {
  @override
  Widget build(BuildContext context) {
    return Consumer<DbFunctionProvider>(
      builder: (context, value, child) {
        var IncomeList=value.TransactionList.where((element) => element.moneytype=='Income',).toList();
      ...
      :CustomScrollView(
        ...
        delegate: SliverChildBuilderDelegate(
          (context, index) {
              final data = IncomeList.reversed.toList()[index];
            return Slidable(
