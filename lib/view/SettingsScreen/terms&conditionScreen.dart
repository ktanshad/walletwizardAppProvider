...
class termsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
         appBar: AppBar(
          title: Center(child: Text('Terms & Conditions',style:GoogleFonts.ubuntu(fontSize: 20,fontWeight: FontWeight.bold,))),
          actions: [Image.asset('asset/settings icons/terms_icon.png',color: Colors.white,height: 40,width: 40,)],
